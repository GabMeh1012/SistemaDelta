...
renumeraron para no dejar huecos. Total: 40 → 37 requisitos.
...
| SD-RF-07 | Portal Profesor / Admin | Autorizar modificación extra de nota desde el portal administrador | TC-NOT-03 | Cubierto | |
...
| SD-RF-14 | Portal Estudiante | Permitir al estudiante solicitar retiro de una materia | TC-MAT-02 | Cubierto | Al aprobarse el retiro se eliminan permanentemente notas y asistencia de esa inscripción (defecto ya reportado); la funcionalidad de retiro en sí está cubierta |
...
| SD-RF-18 | Portal Profesor / Estudiante | Enviar mensajes internos entre usuarios del sistema | TC-MSG-01 | Cubierto | |
...
| SD-RF-31 | Portal Admin | Crear nuevos usuarios profesores con departamento asignado | TC-USR-02 | Cubierto | |
